namespace Portals_of_Madness
{
    ...
    [Table("PlayerCharactersDatabase")]
    public partial class PlayerCharactersDatabase
    {
        ...
        public PlayerCharacter convToPlayerCharacter()
        {
            return new PlayerCharacter(imageSet, (int)level, name, characterClass, (double)baseHealth, (double)healthMult,
                resourceName, (int)maxResource, (double)basePhysAttack, (double)physAttackMult, (double)baseMagicAttack,
                (double)magicAttackMult, (double)basePhysAttack, (double)physAttackMult, (double)baseMagicArmor,
                (double)magicArmorMult, weaknesses, ability1Name, ability2Name, ability3Name, (int)baseSpeed, rarity);
        }
    }
}
